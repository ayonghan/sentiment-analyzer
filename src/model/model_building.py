...
def main():
    try:
        ...
        # Load the preprocessed training data from the preprocessed directory
        train_data = load_data(
            os.path.join(root_dir, "data/preprocessed/train_processed.csv")
        )
        ...
        logger.error(
            "Failed to complete the feature engineering and model building process: %s",
            e,
        )
        print(f"Error: {e}")
